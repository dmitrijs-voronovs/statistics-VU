...
```
From the results we can observe that a country with limited civil rights for political expression but the right to form political parties (pollib = 1) is predicted to have the highest number of military coups (3.040149) compared to a country with full civil rights (pollib = 2: 1.712241) and a country with no civil rights for political expression (pollib = 3: 0.9643509) when other variables are held at their average levels.
This finding may seem counterintuitive as one might expect more political freedom to result in fewer military coups. As a point of discussion we can mention the fact that the model was fitted using data up until 1989, so it may not be applicable to more recent years.
